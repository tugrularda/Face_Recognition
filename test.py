...
with torch.no_grad():
    ...
    for db_image, db_label in db_data:
        ...
        predict(db_label, threshold_distance_f2, True, true_labels, predicted_labels)

        predict(db_label, threshold_distance_f2, False, true_labels, predicted_labels)
